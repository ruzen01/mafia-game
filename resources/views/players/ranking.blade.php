    ...
    <div class="overflow-y-scroll max-h-[500px] border border-gray-400">
        <table class="min-w-full table-auto shadow-lg rounded-lg overflow-hidden border-collapse border border-gray-500">
            <thead class="bg-gray-700 text-white">
                <tr>
                    <th class="sticky top-0 z-10 border border-gray-400 px-4 py-2 bg-gray-300 text-center">#</th>
            ...
            <tbody>
                ...
                <tr class="{{ $loop->iteration == 1 ? 'bg-yellow-600' : ($loop->iteration == 2 ? 'bg-gray-400' : ($loop->iteration == 3 ? 'bg-yellow-800' : 'bg-blue-'.(900 - $loop->iteration * 10))) }}">
