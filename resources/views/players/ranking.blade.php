...
<div class="container mx-auto py-6">
    ...
    <div class="overflow-y-scroll border border-gray-400">
        <table class="min-w-full table-auto shadow-lg rounded-lg border-collapse border border-gray-500">
            <thead class="fixed bg-gray-700 text-white">
                <tr>
                    <th class="border border-gray-400 px-4 py-2 bg-gray-300 text-center">#</th> <!-- Новый столбец для номера -->
                    <th class="border border-gray-400 px-4 py-2 bg-yellow-500 text-center">Игрок</th>
