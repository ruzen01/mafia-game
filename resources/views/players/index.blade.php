...
<div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-6 justify-items-center">
    @php
    ...
    <a 
        ...
        class="w-48 h-64 bg-zinc-800 rounded-xl shadow-lg border-2 border-zinc-700 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer relative overflow-hidden group block animate-fade-in-up"
        style="animation-delay: {{ $index * 0.1 }}s;"
    >
        <!-- Область фото -->
        <div class="w-full h-36 flex items-start justify-center overflow-hidden bg-zinc-900">
            <img 
