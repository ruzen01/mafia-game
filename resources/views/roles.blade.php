...
<p class="text-center mb-4">Играть роль не сложно. Оставаться собой — вот где искусство.</p>

<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
    @foreach ($roles as $id => $role)
    <div class="cursor-pointer" onclick="openCard('{{ $id }}')">
        <img src="{{ asset($role['image']) ?? 'images/roles/placeholder.png' }}" alt="{{ $role['title'] }}" class="w-full h-32 object-cover rounded-lg
