            ...
            <swiper-slide class="relative bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6 flex flex-col md:flex-row items-center">
                        <!-- Картинка -->
                        <div class="w-full md:w-1/2 h-70 md:h-auto">
                            <img src="{{ asset('images/roles/bessmertniy.png') }}" alt="Бессмертный" class="w-full h-full object-cover rounded-lg shadow-sm border border-gray-300">
                        </div>
                        <!-- Текст -->
                        <div class="w-full md:w-1/2 md:pl-8 text-left">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6 flex flex-col md:flex-row items-center">
                        <!-- Картинка -->
                        <div class="w-full md:w-1/2 h-70 md:h-auto">
                            <img src="{{ asset('images/roles/broker.png') }}" alt="Брокер" class="w-full h-full object-cover rounded-lg shadow-sm border border-gray-300">
                        </div>
                        <!-- Текст -->
                        <div class="w-full md:w-1/2 md:pl-8 text-left">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6 flex flex-col md:flex-row items-center">
                        <!-- Картинка -->
                        <div class="w-full md:w-1/2 h-70 md:h-auto">
                            <img src="{{ asset('images/roles/vzlomshik.png') }}" alt="Взломщик" class="w-full h-full object-cover rounded-lg shadow-sm border border-gray-300">
                        </div>
                        <!-- Текст -->
                        <div class="w-full md:w-1/2 md:pl-8 text-left">
