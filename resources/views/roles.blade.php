        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                    <img src="{{ asset('images/roles/advokat.jpg') }}" alt="Адвокат" class="w-full h-56 object-cover mb-3 rounded-lg">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                    <img src="{{ asset('images/roles/actor.jpg') }}" alt="Актер" class="w-full h-56 object-cover mb-3 rounded-lg">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Депутат</h3>
                        <p class="text-gray-700 text-sm">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Диктатор</h3>
                        <p class="text-gray-700 text-sm">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Дон</h3>
                        <p class="text-gray-700 text-sm">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Киллер</h3>
                        <p class="text-gray-700 text-sm">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Клерк</h3>
                        <p class="text-gray-700 text-sm">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Клоун</h3>
                        <p class="text-gray-700 text-sm">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Комиссар</h3>
                        <p class="text-gray-700 text-sm">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Купидон</h3>
                        <p class="text-gray-700 text-sm">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Лузер</h3>
                        <p class="text-gray-700 text-sm">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Марв</h3>
                        <p class="text-gray-700 text-sm">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Математик</h3>
                        <p class="text-gray-700 text-sm">
                ...
                <div class="swiper-slide relative bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-4">Мирный</h3>
                        <p class="text-gray-700 text-sm">
