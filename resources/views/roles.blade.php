...
<style>
    ...
    .swiper-slide {
        ...
        min-height: 400px; /* Фиксированная высота для десктопной версии */
        display: flex;
    ...
    @media (max-width: 640px) {
        .swiper-slide {
            min-height: 350px; /* Фиксированная высота для мобильной версии */
        }
    }
    ...
    .swiper-slide img {
        ...
        border-top-left-radius: 15px; /* Скругление верхних углов */
    ...
    .swiper-slide p {
        ...
        padding: 0 1rem 1rem; /* Отступы */
        overflow: hidden;
        text-overflow: ellipsis;
        display: -webkit-box;
        -webkit-line-clamp: 5; /* Ограничение количества строк */
        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/advokat.jpg') }}" alt="Адвокат">
                    <h3>Адвокат</h3>
                    <p>
                ...
                <!-- Карточка Актёра -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/actor.jpg') }}" alt="Актер">
                    <h3>Актёр</h3>
                    <p>
                ...
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/bessmertnyi.jpg') }}" alt="Бессмертный">
                    <h3>Бессмертный</h3>
                    <p>
                ...
                <!-- Карточка Брокера -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/broker.jpg') }}" alt="Брокер">
                    <h3>Брокер</h3>
                    <p>
                ...
                <!-- Карточка Взломщика -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/vzlomshchik.jpg') }}" alt="Взломщик">
                    <h3>Взломщик</h3>
                    <p>
                ...
                <!-- Карточка Вора -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/vor.jpg') }}" alt="Вор">
                    <h3>Вор</h3>
                    <p>
                ...
                <!-- Карточка Депутата -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/deputat.jpg') }}" alt="Депутат">
                    <h3>Депутат</h3>
                    <p>
                ...
                <!-- Карточка Диктатора -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/diktator.jpg') }}" alt="Диктатор">
                    <h3>Диктатор</h3>
                    <p>
                ...
                <!-- Карточка Доктора -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/doktor.jpg') }}" alt="Доктор">
                    <h3>Доктор</h3>
                    <p>
                ...
                <!-- Карточка Дона -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/don.jpg') }}" alt="Дон">
                    <h3>Дон</h3>
                    <p>
                ...
                <!-- Карточка Киллера -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/killer.jpg') }}" alt="Киллер">
                    <h3>Киллер</h3>
                    <p>
                ...
                <!-- Карточка Клерка -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/klerk.jpg') }}" alt="Клерк">
                    <h3>Клерк</h3>
                    <p>
                ...
                <!-- Карточка Клоуна -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/kloun.jpg') }}" alt="Клоун">
                    <h3>Клоун</h3>
                    <p>
                ...
                <!-- Карточка Комиссара -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/komissar.jpg') }}" alt="Комиссар">
                    <h3>Комиссар</h3>
                    <p>
                ...
                <!-- Карточка Купидона -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/kupidon.jpg') }}" alt="Купидон">
                    <h3>Купидон</h3>
                    <p>
                ...
                <!-- Карточка Лузера -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/luzer.jpg') }}" alt="Лузер">
                    <h3>Лузер</h3>
                    <p>
                ...
                <!-- Карточка Маньяка -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/maniak.jpg') }}" alt="Маньяк">
                    <h3>Маньяк</h3>
                    <p>
                ...
                <!-- Карточка Марва -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/marv.jpg') }}" alt="Марв">
                    <h3>Марв</h3>
                    <p>
                ...
                <!-- Карточка Математика -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/matematik.jpg') }}" alt="Математик">
                    <h3>Математик</h3>
                    <p>
                ...
                <!-- Карточка Мирного -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/roles/mirnyi.jpg') }}" alt="Мирный">
                    <h3>Мафия</h3>
                        <p>
