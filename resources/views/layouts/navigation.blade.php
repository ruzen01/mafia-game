...
<nav class="bg-zinc-800 py-3 px-4 shadow-lg sticky top-0 z-50" id="navbar">
    <div class="container mx-auto flex items-center justify-between">
        ...
        <div class="flex sm:hidden flex-grow justify-center space-x-3">
            <a href="{{ route('rules') }}" class="text-white hover:text-zinc-300 transition-colors duration-200 flex flex-col items-center" title="Правила">
                ...
                <span class="text-xs mt-0.5">Правила</span>
            </a>
            <a href="{{ route('roles') }}" class="text-white hover:text-zinc-300 transition-colors duration-200 flex flex-col items-center" title="Роли">
                ...
                <span class="text-xs mt-0.5">Роли</span>
            </a>
            <a href="{{ route('players.ranking') }}" class="text-white hover:text-zinc-300 transition-colors duration-200 flex flex-col items-center" title="Рейтинг">
                ...
                <span class="text-xs mt-0.5">Рейтинг</span>
            </a>
            <a href="{{ route('games.index') }}" class="text-white hover:text-zinc-300 transition-colors duration-200 flex flex-col items-center" title="Игры">
                ...
                <span class="text-xs mt-0.5">Игры</span>
            </a>
            <a href="{{ route('players.index') }}" class="text-white hover:text-zinc-300 transition-colors duration-200 flex flex-col items-center" title="Игроки">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                  <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/>
                </svg>
                <span class="text-xs mt-0.5">Игроки</span>
            </a>
        </div>
        ...
        <div class="flex sm:hidden items-center space-x-3">
            @auth
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="text-white hover:text-red-400 transition-colors duration-200" title="Выйти">
            ...
            @else
                <a href="{{ route('login') }}" class="text-white hover:text-zinc-300 transition-colors duration-200" title="Войти">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0v-2z"/>
                      <path fill-rule="evenodd" d="M11.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H1.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
                    </svg>
                </a>
                <a href="{{ route('register') }}" class="text-white hover:text-zinc-300 transition-colors duration-200" title="Регистрация">
