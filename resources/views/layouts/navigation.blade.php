...
<nav class="bg-gray-900 p-6 shadow-lg sticky top-0 z-50" id="navbar">
...
<div id="sidebar" class="fixed left-0 w-64 bg-gray-800 shadow-lg transform -translate-x-full transition-transform duration-300 ease-in-out z-40 top-[64px] bottom-0 overflow-y-auto">
