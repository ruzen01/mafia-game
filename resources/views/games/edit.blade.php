    ...
    <form action="{{ route('games.update', $game->id) }}" method="POST">
        ...
        <div class="flex flex-wrap gap-4 mb-4 w-full">
            <div class="flex-1">
                ...
                <input type="date" name="date" id="date" value="{{ $game->date }}" class="border rounded py-2 px-3 w-full h-10 bg-gray-800" required>
            </div>
            <div class="flex-1">
        ...
        <div class="flex flex-wrap gap-4 mb-4 w-full">
            <div class="flex-1">
                ...
                <input type="text" name="name" id="name" value="{{ $game->name }}" class="border rounded py-2 px-3 w-full h-10 bg-gray-800" required>
            </div>
            <div class="flex-1">
                <label for="host_name" class="block text-sm font-medium">Ведущий:</label>
                <input type="text" name="host_name" id="host_name" value="{{ $game->host_name }}" class="border rounded w-full py-2 px-3 h-10 bg-gray-800" required>
            </div>
            <div class="flex-1">
