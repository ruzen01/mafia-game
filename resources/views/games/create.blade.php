...
<div class="container mx-auto py-6">
    ...
    <form action="{{ route('games.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <button type="button" id="add-player-row" class="bg-green-500 py-2 px-4 mt-2 rounded h-10 w-48">Добавить игрока</button>
        </div>

        <!-- Кнопка создания игры -->
        <button type="submit" class="bg-blue-500 py-3 px-6 rounded font-bold text-lg">Создать игру</button>
    </form>
</div>
