...
<div class="container mx-auto py-6">
    ...
    <h1 class= text-3xl font-bold mb-6">Список игр</h1>
    ...
    <div class="overflow-x-auto rounded-lg shadow-lg">
        <table class="table-fixed w-full">
            <thead class="bg-gray-700 text-white sticky top-0 z-10">
                <tr>
                    <th class="truncate w-1/16 px-4 py-2">Дата</th>
                    <th class="truncate w-4/16 px-4 py-2">Имя</th>
                    <th class="truncate w-1/16 px-4 py-2">№</th>
                    <th class="truncate w-2/16 px-4 py-2">Ведущий</th>
                    <th class="truncate w-2/16 px-4 py-2">Сезон</th>
                    <th class="truncate w-2/16 px-4 py-2">Победитель</th>
                    <th class="truncate w-2/16 px-4 py-2">Игроки</th>
                    @can('update', App\Models\Game::class)
                    <th class="truncate w-2/16 px-4 py-2">Действия</th>
                    @endcan
                </tr>
            </thead>
    ...
    <div class="flex items-center justify-center -space-x-2 overflow-visible">
        ...
        @endif 
                    ...
                    @can('update', [$game])
                    <td class="w-2/16 px-4 py-1 whitespace-nowrap">
